...
class Product extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.product',[
            'products' => $products,
            'products' => ProductModel::where('name','like', $searchParams)
                                        ->orWhere('type', 'like', $searchParams)
                                        ->orWhere('price', 'like', $searchParams)->latest()->paginate(5)
        ], compact('types'));
    }
    ...
    public function delete($id){
        ...
        session()->flash('delete','Buku Deleted Successfully');
    }
