                    ...
                    <div class="row">
                        @forelse ($products as $product )
                            <div class="col-md-3 mb-3">
                                <div class="card">
                                    <div class="card-body">
                                        <img src="{{ url('storage/image/'. $product->image)}}" alt="product" style="object-fit: contain; width:100%; height:125px">
                            ...
                            @forelse($carts as $index=>$cart)
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <button class="btn btn-danger btn-sm" style="padding: 3px 5px"  wire:click="decreaseItem('{{$cart['rowId']}}')"><i class="fas fa-minus"></i></button>
                                            {{$cart['qty']}}
